...
class DBWNode(object):
    ...
    def loop(self):
        rate = rospy.Rate(DBW_RATE_HZ) # 50Hz
        while not rospy.is_shutdown():
            ...
            self.throttle, self.brake, self.steering = self.controller.control(self.proposed_linear_vel,
